                        ...
                        <div class="lg:px-2 lg:w-1/2">
                            ...
                            <div class="p-4">
                                <div class="justify-center md:flex">
                                    <div
                                        class="flex items-center w-full h-13 pl-3 bg-gray-100 border rounded-full"
                                    >
                                        <input
                                            type="coupon"
                                            name="code"
                        ...
                        <div class="ml-16 pt-10 bg-gray-800 rounded-t-2xl lg:px-2 lg:w-1/2">
                            ...
                            <div class="p-4">
                                ...
                                <div class="flex justify-between pt-4 border-b">
                                    <div
                                        class="flex lg:px-4 lg:py-2 m-2 text-lg lg:text-xl font-bold text-gray-100"
                                    >
                                        <svg
                                            class="w-4 mr-5 text-gray-100 hover:text-yellow-500"
                                            xmlns="http://www.w3.org/2000/svg"
                                            viewBox="0 0 24 24"
                                        >
                                            <path
                                ...
                                <button
                                    class="flex justify-center w-full px-10 py-3 mt-6 font-medium text-white uppercase bg-gray-700 rounded-full shadow item-center hover:bg-gray-500 focus:shadow-outline focus:outline-none"
                                >
                                    <svg
                                        aria-hidden="true"
                                        data-prefix="far"
